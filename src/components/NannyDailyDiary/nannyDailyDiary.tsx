...
//styles
import styles from './nannyDailyDiary.module.scss';

//svg
import ImageSection from '../../assets/ImageSection5.svg';


const NannyDailyDiary: React.FC = () => {
  return (
    <div className={styles.nannyDailyDiary}>
      <img src={ImageSection} alt="Section 5" />
...
export default NannyDailyDiary;